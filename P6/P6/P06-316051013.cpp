...
void CrearDecagono()
{
	...
	GLfloat vertices[] = {
		//	x		y		z
		//1
		-0.35f,	0.25f,	-0.5f,		0.75f,	0.3f,		0.0f,	0.0f,	0.0f,		//A-0
		-0.56f,	-0.4f,	0.43f,		0.75f,	0.3f,		0.0f,	0.0f,	0.0f,		//D-3
		-0.9f,	-0.15f,	0.69f,		0.75f,	0.3f,		0.0f,	0.0f,	0.0f,		//B-1
		-1.03f,	0.25f,	0.43f,		0.75f,	0.3f,		0.0f,	0.0f,	0.0f,		//C-2
		/*
		* 
		* Por las mediciones estas son las coordenadas que debería tener la cara //1 pero
		* al ingresarlas no las reconoce, por lo tanto adoptaremos colores variados
		* acordes a difrentes caras
		* .75 .5
		* .93 .22
		* .85 0.02
		* .75 0.02
		*/
		...
		//2
		-0.35f,	0.25f,  -0.5f,		0.3f,   0.5f,		0.0f,	0.0f,	0.0f,	//A-4
		-1.03f,	0.25f,  0.43f,		0.3f,	0.5f,		0.0f,	0.0f,	0.0f,	//C-5
		-0.9f,	0.65f,  0.69f,		0.3f,   0.5f,		0.0f,	0.0f,	0.0f,	//E-6
		-0.56f,	0.9f,  0.43f,		0.3f,	0.5f,		0.0f,	0.0f,	0.0f,	//F-7
		
		//3
		-0.35f,	0.25f,  -0.5f,		0.35f,  0.7f,		0.0f,	0.0f,	0.0f,	//A-8
		-0.56f,	0.9f,  0.43f,		0.35f,	0.7f,		0.0f,	0.0f,	0.0f,	//F-9
		-0.13f,	0.9f,  0.69f,		0.35f,	0.7f,		0.0f,	0.0f,	0.0f,	//G-10
		0.21f,  0.65f,  0.43f,		0.35f,	0.7f,		0.0f,	0.0f,	0.0f,	//H-11
		
		//4
		-0.35f,	0.25f,  -0.5f,		0.5f,   0.45f,		0.0f,	0.0f,	0.0f,	//A-12
		0.21f,  0.65f,  0.43f,		0.5f,	0.45f,		0.0f,	0.0f,	0.0f,	//H-13
		0.34f,	0.25f,  0.69f,		0.5f,   0.45f,		0.0f,	0.0f,	0.0f,	//I-14
		0.21f,	-0.15f,  0.43f,		0.5f,	0.45f,		0.0f,	0.0f,	0.0f,	//J-15

		//5
		-0.35f,	0.25f,  -0.5f,		0.5f,   0.5f,		0.0f,	0.0f,	0.0f,	//A-16
		0.21f,	-0.15f,  0.43f,		0.5f,	0.5f,		0.0f,	0.0f,	0.0f,	//J-17
		-0.13f,	-0.4f,  0.69f,		0.5f,	0.5f,		0.0f,	0.0f,	0.0f,	//K-18
		-0.56f,  -0.4f,  0.43f,		0.5f,	0.5f,		0.0f,	0.0f,	0.0f,	//D-19
		
		//6
		-0.35f,  0.25f,  1.61f,		0.8f,	0.4f,		0.0f,	0.0f,	0.0f,	//L-20
		-0.9f,	-0.15f,  0.69f,		0.8f,	0.4f,		0.0f,	0.0f,	0.0f,	//B-21
		-1.03f,	0.25f,  0.43f,		0.8f,	0.4f,		0.0f,	0.0f,	0.0f,	//C-22
		-0.9f,	0.65f,  0.69f,		0.8f,   0.4f,		0.0f,	0.0f,	0.0f,	//E-23

		//7
		-0.35f,  0.25f,  1.61f,		0.77f,	0.38f,		0.0f,	0.0f,	0.0f,	//L-24
		-0.9f,	0.65f,  0.69f,		0.77f,  0.38f,		0.0f,	0.0f,	0.0f,	//E-25
		-0.56f,	0.9f,  0.43f,		0.77f,	0.38f,		0.0f,	0.0f,	0.0f,	//F-26
		-0.13f,	0.9f,  0.69f,		0.77f,	0.38f,		0.0f,	0.0f,	0.0f,	//G-27

		//8
		-0.35f,  0.25f,  1.61f,		0.9f,	0.5f,		0.0f,	0.0f,	0.0f,	//L-28
		-0.13f,	0.9f,  0.69f,		0.9f,	0.5f,		0.0f,	0.0f,	0.0f,	//G-29
		0.21f,  0.65f,  0.43f,		0.9f,	0.5f,		0.0f,	0.0f,	0.0f,	//H-30
		0.34f,	0.25f,  0.69f,		0.9f,   0.5f,		0.0f,	0.0f,	0.0f,	//I-31

		//9
		-0.35f,  0.25f,  1.61f,		0.1f,	0.8f,		0.0f,	0.0f,	0.0f,	//L-32
		0.34f,	0.25f,  0.69f,		0.1f,   0.8f,		0.0f,	0.0f,	0.0f,	//I-33
		0.21f,	-0.15f,  0.43f,		0.1f,	0.8f,		0.0f,	0.0f,	0.0f,	//J-34
		-0.13f,	-0.4f,  0.69f,		0.1f,	0.8f,		0.0f,	0.0f,	0.0f,	//K-35

		//10
		-0.35f,  0.25f,  1.61f,		0.78f,	0.1f,		0.0f,	0.0f,	0.0f,	//L-36
		-0.13f,	-0.4f,  0.69f,		0.78f,	0.1f,		0.0f,	0.0f,	0.0f,	//K-37
		-0.56f,  -0.4f,  0.43f,		0.78f,	0.1f,		0.0f,	0.0f,	0.0f,	//D-38
		-0.9f,	-0.15f,  0.69f,		0.78f,	0.1f,		0.0f,	0.0f,	0.0f,	//B-39
		//*/
	};
