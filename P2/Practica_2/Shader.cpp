...
Shader::Shader() //si no se crea un shader se manda un shader vacío
{
	shaderID = 0;
	uniformModel = 0;
	uniformProjection = 0;
...
void Shader::CreateFromFiles(const char* vertexLocation, const char* fragmentLocation)
{
	...
	const char* vertexCode = vertexString.c_str(); //se hace un cast para string
	const char* fragmentCode = fragmentString.c_str(); //se hace un cast para string
...
//agregar get para nuevas variables uniform
