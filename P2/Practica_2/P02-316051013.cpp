...
int main()
{
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//---------------------------------------------------------------------------------------------------------
		//FIGURA DE CASA CON CUBO Y PIRÁMIDE
		//---------------------------------------------------------------------------------------------------------
		...
		model = glm::scale(model, glm::vec3(1.0f, 1.3f, 0.0f)); // Ajusta el tamaño del cuadro rojo
		//se agrega la rotacion
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		//fin rotacion
		...
		//Inicializar matriz de dimensión 4x4 que servirá como matriz de modelo para almacenar las transformaciones geométricas
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(0.0f, 0.505f, -3.0f)); // Ajusta la posición del triángulo azul
		model = glm::scale(model, glm::vec3(1.3f, 0.5f, 0.0f)); // Ajusta el tamaño del triángulo azul
		//se agrega la rotacion
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		//fin rotacion
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.78f, -0.537f, -3.0f)); // Ajusta la posición del triángulo verde
		model = glm::scale(model, glm::vec3(0.48f, 0.56f, 0.0)); // Ajusta el tamaño del triángulo verde
		//se agrega la rotacion
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		//fin rotacion
		...
		model = glm::mat4(1.0);
		model = glm::translate(model, glm::vec3(-0.78f, -0.935f, -3.0f)); // Ajusta la posición del cuadro_cafe 
		model = glm::scale(model, glm::vec3(0.18f, 0.23f, 0.0f)); // Ajusta el tamaño del cuadro_cafe 
		//se agrega la rotacion
		//model = glm::rotate(model, glm::radians(angulo), glm::vec3(0.0f, 1.0f, 0.0f));
		//fin rotacion
