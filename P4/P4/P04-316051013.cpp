...
int main()
{
	...
	*/
	...
	glm::mat4 modelart(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía 
	glm::mat4 modelcol(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelcol_1(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía 
	glm::mat4 modelvar_1(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_2(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_3(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_4(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_5(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_6(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_7(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	glm::mat4 modelvar_8(1.0);//Inicializar matriz de Modelo 4x4 auxiliar para la jerarquía
	...
	while (!mainWindow.getShouldClose())
	{
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> 1
		//--------------------------
		...
		modelvar = model;
		model = glm::scale(model, glm::vec3(7.0f, 2.0f, 4.0f));
		glUniformMatrix4fv(uniformModel, 1, GL_FALSE, glm::value_ptr(model));
		...
		//articulacion general llantas - 1
		model = modelvar;
		...
		//articulacion general llantas - 2
		model = modelaux1;
		...
		//articulacion general llantas - 3
		model = modelvar;
		model = glm::translate(model, glm::vec3(-3.5f, -1.0f, 2.0f));
		modelaux2 = model;
		...
		//articulacion general llantas - 4
		model = modelaux2;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -4.0f));
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> LLANTA 1
		//--------------------------
		model = modelvar_1;
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> LLANTA 2
		//--------------------------
		model = modelvar_2;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.25f));
		//modelvar_1 = model;
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> LLANTA 3
		//--------------------------
		model = modelvar_3;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, 0.25f));
		//modelvar_1 = model;
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> LLANTA 4
		//--------------------------
		model = modelvar_4;
		model = glm::translate(model, glm::vec3(0.0f, 0.0f, -0.25f));
		//modelvar_1 = model;
		...
		//--------------------------
		//Bifurcacion modelo jerarquico -> 2
		//--------------------------
